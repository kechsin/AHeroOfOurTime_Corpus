...
Активируем виртуальную среду: для Mac `source venv/bin/activate`, а для Windowc `venv\Scripts\activate`. 

Загружаем нужнве библиотеки с помощью команты`pip install -r requirements.txt`.
