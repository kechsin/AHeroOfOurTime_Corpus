...
![скриншот базы данных Рахилиной](example.com/logo.png)
...
В качестве одной из фишек проекта мы решили выделить устаревшие слова в нашем датасете. На сайте они будут обозначены подчеркиванием. Список устаревших слов мы брали с помощью парсинга с сайта [Словаря устаревших слов]([https://azbyka.ru/otechnik/Spravochniki/slovar-ustarevshih-slov/](https://i.imgur.com/KXLwfKY.png)).
