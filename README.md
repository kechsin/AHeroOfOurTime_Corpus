...
В поисковом запросе `знать+NOUN` мы решили, что будем искать лемму слова, потому что полезнее узнать общее количество употреблений слова знать в значении существительного, чем искать определенную словоформу.
